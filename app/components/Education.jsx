...
const Education = () => {
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} id="education" className='w-full px-8 sm:px-[12%] py-10 scroll-mt-20 mb-20'>
            <motion.h2 initial={{ y: -20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 0.5 }} className='text-center text-5xl font-Ovo'>Education</motion.h2>

            {/* Timeline Container */}
            <div className="relative mt-10">
                {/* Middle Line - Only visible in sm and above */}
                ...
                <div className="flex flex-col gap-10">
                    {educationData.map((edu, index) => (
                        ...
                        >
                            {/* Timeline Dot - Only visible in sm and above */}
